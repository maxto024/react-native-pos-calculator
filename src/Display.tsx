...
import { findNodeHandle, NativeModules, Platform, StyleProp, StyleSheet, Text, TextStyle, View } from 'react-native';
...
export class Display extends React.Component<DisplayProps, State> {
   ...
   renderIOS() {
      const { height, style, value, color, title } = this.props;
      return (
         <View>
   ...
   renderAndroid() {
      ...
      return (
         <View>
            <Text ref={component => (this._text = component)} style={[styles.hiddenText, { fontSize: size }]}>
               {value}
            </Text>
            <Text
               style={[
